...
const PricingCards = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      {/* Pricing Card 1 */}
      <div className="space-y-6 h-full bg-[#F9FAFC] flex flex-col justify-between text-start items-start border border-gray-200 py-7 px-8 rounded-2xl shadow-2xl hover:shadow-xl hover:scale-105 hover:-translate-y-1 duration-200 active:scale-95 active:translate-y-0 mb-16">
      ...
      <div className="relative h-full -top-9 space-y-6 bg-linear-to-l from-[#9514FA] to-[#4F39F6] border border-[#3B82F6] flex flex-col justify-between text-start items-start text-white py-7 px-8 rounded-2xl shadow-2xl hover:shadow-xl hover:scale-105 hover:-translate-y-1 duration-200 active:scale-95 active:translate-y-0">
        ...
        <button
          className="w-full h-full text-[14px] md:text-[16px] font-extrabold py-3 px-4 rounded-3xl cursor-pointer shadow-lg hover:scale-105 hover:-translate-y-1 duration-200 active:scale-95 active:translate-y-0 bg-white 
          "
        >
